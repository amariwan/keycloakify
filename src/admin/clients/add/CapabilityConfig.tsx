      ...
      {protocol === "openid-connect" && (
        <>
          ...
          <FormGroup
            ...
            labelIcon={
              <HelpItem helpText={t("authorizationHelp")} fieldLabelId="authorization" />
            }
          >
            <Controller
          ...
          <FormGroup hasNoPaddingTop label={t("authenticationFlow")} fieldId="kc-flow">
      ...
      {protocol === "saml" && (
        <>
          <DefaultSwitchControl
            name={convertAttributeNameToForm<FormFields>("attributes.saml.encrypt")}
