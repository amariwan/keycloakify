...
export const SamlKeysDialog = ({ id, attr, onClose, onCancel }: SamlKeysDialogProps) => {
  ...
  return (
    ...
    >
      <FormProvider {...form}>
        <Form isHorizontal>
          <FormGroup label={t("selectMethod")} fieldId="selectMethod" hasNoPaddingTop>
            <Flex>
              <FlexItem>
                <Radio
                  isChecked={!type}
          ...
          {!type && (
            <FormGroup
              ...
              fieldId="certificate"
              labelIcon={
                <HelpItem helpText={t("certificateHelp")} fieldLabelId="certificate" />
              }
            >
              <Split hasGutter>
                <SplitItem isFilled>
                ...
                <SplitItem>
                  <Button variant="secondary" data-testid="generate" onClick={generate}>
                    {t("generate")}
                  </Button>
                </SplitItem>
              </Split>
