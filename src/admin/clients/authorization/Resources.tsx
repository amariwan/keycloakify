    ...
    <PageSection variant="light" className="pf-v5-u-p-0">
            ...
            <>
              ...
              <ToolbarItem>
                <Button
                  ...
                  component={props => (
                    <Link {...props} to={toCreateResource({ realm, id: clientId })} />
                  )}
                >
                  {t("createResource")}
                </Button>
              ...
              {resources.map((resource, rowIndex) => (
                <Tbody key={resource._id} isExpanded={resource.isExpanded}>
                  <Tr>
                    ...
                    <Td>
                      <TableText wrapModifier="truncate">{resource.type}</TableText>
                    </Td>
                    <Td>
                      <TableText wrapModifier="truncate">
                        {resource.owner?.name}
                  ...
                  <Tr key={`child-${resource._id}`} isExpanded={resource.isExpanded}>
                    <Td />
                    <Td colSpan={4}>
                      <ExpandableRowContent>
                        {resource.isExpanded && (
      ...
      {noData && !searching && (
        <ListEmptyState
          ...
          onPrimaryAction={() => navigate(toCreateResource({ realm, id: clientId }))}
        />
      )}
    </PageSection>
  );
