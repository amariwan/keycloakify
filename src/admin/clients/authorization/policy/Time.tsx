...
const DateTime = ({ name }: { name: string }) => {
  ...
  return (
    <Controller
      ...
      rules={{ required: true }}
      render={({ field }) => {
        const dateTime = field.value.match(DATE_TIME_FORMAT) || ["", "", "0", "00"];
        return (
  ...
  return (
    <>
      ...
      <FormGroup
        label={t("startTime")}
        fieldId="notBefore"
        labelIcon={<HelpItem helpText={t("startTimeHelp")} fieldLabelId="startTime" />}
        isRequired
      >
      ...
      <FormGroup
        ...
        labelIcon={<HelpItem helpText={t("expireTimeHelp")} fieldLabelId="expireTime" />}
        isRequired
      >
