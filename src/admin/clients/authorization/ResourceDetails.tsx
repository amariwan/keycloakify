...
export default function ResourceDetails() {
  ...
  const submit = async (submitted: SubmittedResource) => {
    const resource = convertFormValuesToObject<SubmittedResource, ResourceRepresentation>(
      submitted
    );
        ...
        <FormProvider {...form}>
          ...
          >
            ...
            <FormGroup
              label={t("uris")}
              fieldId="uris"
              labelIcon={<HelpItem helpText={t("urisHelp")} fieldLabelId="uris" />}
            >
              <MultiLineInput
                name="uris"
                type="url"
            ...
            <ActionGroup>
              <div className="pf-v5-u-mt-md">
                <Button variant={ButtonVariant.primary} type="submit" data-testid="save">
                  {t("save")}
                </Button>
