...
export type AddScopeDialogProps = {
  ...
  open: boolean;
  toggleDialog: () => void;
  onAdd: (scopes: { scope: ClientScopeRepresentation; type?: ClientScopeType }[]) => void;
      ...
      actions={
        isClientScopesConditionType
          ...
          : [
              ...
              >
                <DropdownList>{clientScopeTypesDropdown(t, action)}</DropdownList>
              </Dropdown>,
              <Button
                id="modal-cancel"
                key="cancel"
    ...
    >
      <KeycloakDataTable
        ...
        searchTypeComponent={
          ...
          >
            <DropdownList>
              <DropdownItem data-testid="filter-type-dropdown-item" key="filter-type">
          ...
          filterType === FilterType.Protocol && (
            <>
              ...
              <KeycloakSelect
                ...
                onSelect={value => onProtocolTypeDropdownSelect(value.toString())}
