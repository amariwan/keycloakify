...
export default function ClientScopesSection() {
  ...
  const [selectedScopes, setSelectedScopes] = useState<ClientScopeDefaultOptionalType[]>(
    []
  );
        ...
        <KeycloakDataTable
          ...
          toolbarItem={
            <>
              ...
              <ToolbarItem>
                <ChangeTypeDropdown selectedRows={selectedScopes} refresh={refresh} />
              </ToolbarItem>
              <ToolbarItem>
                <Dropdown
          ...
          columns={[
            ...
            },
            {
              ...
              cellRenderer: row => <TypeSelector {...row} refresh={refresh} />
            },
            {
              name: "protocol",
              displayKey: "protocol",
