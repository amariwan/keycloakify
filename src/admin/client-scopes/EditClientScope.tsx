...
import { useAlerts, useFetch, useHelp } from "../../shared/keycloak-ui-shared";
import {
  Alert,
  AlertVariant,
  ButtonVariant,
...
import { ClientScopeParams, ClientScopeTab, toClientScope } from "./routes/ClientScope";
        ...
        <RoutableTabs isBox>
          ...
          >
            <MapperList
              ...
              onAdd={addMappers}
              onDelete={onDelete}
              detailLink={id => toMapper({ realm, id: clientScope.id!, mapperId: id! })}
            />
          </Tab>
          <Tab
            id="scope"
