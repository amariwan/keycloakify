  ...
  const save = async (mapper: ComponentRepresentation) => {
    ...
    try {
      if (mapperId === "new") {
        ...
        navigate(toUserFederationLdap({ realm, id: mapper.parentId!, tab: "mappers" }));
      } else {
      ...
      addError(mapperId === "new" ? "mappingCreatedError" : "mappingUpdatedError", error);
    }
  };
          ...
          isNew
            ...
            : [
                ...
                ...(mapper?.metadata.fedToKeycloakSyncSupported
                  ? [
                      <DropdownItem key="fedSync" onClick={() => sync("fedToKeycloak")}>
          ...
          >
            ...
            {!isNew ? (
              ...
              <FormGroup
                ...
                labelIcon={
                  <HelpItem
                    helpText={mapper?.helpText ? mapper.helpText : t("mapperTypeHelp")}
                        ...
                        setupForm({
                          ...
                          ...Object.fromEntries(
                            components
                              ...
                              .map(m => [convertToName(m.name!), m.options?.[0]]) || []
                          )
                        });
            ...
            {!!mapperType && <DynamicComponents properties={mapper?.properties!} />}
            <ActionGroup>
              <Button
