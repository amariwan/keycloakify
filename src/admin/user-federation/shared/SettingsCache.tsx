  ...
  return (
    <>
      <FormGroup
        label={t("cachePolicy")}
        labelIcon={
          <HelpItem helpText={t("cachePolicyHelp")} fieldLabelId="cachePolicy" />
        }
      ...
      isEqual(cachePolicyType, ["EVICT_WEEKLY"]) ? (
        <>
          <FormGroup
            ...
            labelIcon={
              <HelpItem helpText={t("evictionHourHelp")} fieldLabelId="evictionHour" />
            }
            isRequired
      ...
      {isEqual(cachePolicyType, ["MAX_LIFESPAN"]) ? (
        <FormGroup
          label={t("maxLifespan")}
          labelIcon={
            <HelpItem helpText={t("maxLifespanHelp")} fieldLabelId="maxLifespan" />
          }
