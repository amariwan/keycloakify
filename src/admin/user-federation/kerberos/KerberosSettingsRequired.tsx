  ...
  return (
    <FormProvider {...form}>
      ...
      <FormAccess role="manage-realm" isHorizontal>
        ...
        <input type="hidden" defaultValue="kerberos" {...form.register("providerId")} />
        <input
          type="hidden"
          defaultValue="org.keycloak.storage.UserStorageProvider"
          {...form.register("providerType")}
        />
        <input type="hidden" defaultValue={realm} {...form.register("parentId")} />
        <TextControl
          name="name"
        ...
        <FormGroup
          label={t("debug")}
          labelIcon={<HelpItem helpText={t("debugHelp")} fieldLabelId="debug" />}
          fieldId="kc-debug"
          hasNoPaddingTop
        >
          <Controller
