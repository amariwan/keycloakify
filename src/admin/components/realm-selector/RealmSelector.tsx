 ...
 *
 * $ npx keycloakify own --path 'admin/components/realm-selector/RealmSelector.tsx'
 *
...
import { label, useFetch } from "../../../shared/keycloak-ui-shared";
import {
  Button,
  Divider,
  Dropdown,
      ...
      <DropdownList>
        ...
        {(realms.length !== 0
          ? [
              ...
              ...sortedRealms.map(realm => (
                ...
                >
                  <RealmText
                    {...realm}
                    showIsRecent={realms.length > 5 && recentRealms.includes(realm.name)}
                  />
                </DropdownItem>
              )),
          ...
          : !search
            ...
            : [<DropdownItem key="no-results">{t("noResultsFound")}</DropdownItem>]
        ).concat([
