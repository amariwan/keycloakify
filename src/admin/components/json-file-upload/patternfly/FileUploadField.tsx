 ...
 *
 * $ npx keycloakify own --path 'admin/components/json-file-upload/patternfly/FileUploadField.tsx'
 *
      ...
      <div className={styles.fileUploadFileDetails}>
        {!hideDefaultPreview && type === fileReaderType.text && (
          <TextArea
            ...
            onChange={(event, newValue: string) => onTextAreaChange(newValue, event)}
