...
export const RealmSettingsSessionsTab = ({
  ...
  const { setValue, control, handleSubmit, formState } = useForm<RealmRepresentation>();
  ...
  return (
    <PageSection variant="light">
      <FormPanel title={t("SSOSessionSettings")} className="kc-sso-session-template">
        <FormAccess isHorizontal role="manage-realm" onSubmit={handleSubmit(save)}>
          <FormGroup
            label={t("SSOSessionIdle")}
            fieldId="SSOSessionIdle"
            labelIcon={
              <HelpItem helpText={t("ssoSessionIdle")} fieldLabelId="SSOSessionIdle" />
            }
          >
            <Controller
          ...
          <FormGroup
            ...
            labelIcon={
              <HelpItem helpText={t("ssoSessionMax")} fieldLabelId="SSOSessionMax" />
            }
          >
            <Controller
      ...
      <FormPanel className="kc-login-settings-template" title={t("loginSettings")}>
        ...
        >
          <FormGroup
            ...
            fieldId="offlineSessionIdle"
            labelIcon={
              <HelpItem helpText={t("loginTimeoutHelp")} fieldLabelId="loginTimeout" />
            }
          >
            <Controller
