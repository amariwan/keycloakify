 ...
 *
 * $ npx keycloakify own --path 'admin/realm-settings/ThemesTab.tsx'
 *
...
import { HelpItem, KeycloakSelect, SelectVariant } from "../../shared/keycloak-ui-shared";
import {
  ActionGroup,
  Button,
  FormGroup,
...
export const RealmSettingsThemesTab = ({ realm, save }: RealmSettingsThemesTabProps) => {
    ...
    <PageSection variant="light">
      ...
      >
        ...
        <FormGroup
          ...
          labelIcon={
            <HelpItem helpText={t("accountThemeHelp")} fieldLabelId="accountTheme" />
          }
        >
          <Controller
            name="accountTheme"
        ...
        <FormGroup
          ...
          labelIcon={
            <HelpItem helpText={t("adminThemeHelp")} fieldLabelId="adminTheme" />
          }
        >
          <Controller
            name="adminTheme"
        ...
        <FormGroup
          ...
          labelIcon={
            <HelpItem helpText={t("emailThemeHelp")} fieldLabelId="emailTheme" />
          }
        >
          <Controller
            name="emailTheme"
