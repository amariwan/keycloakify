  ...
  return (
    <PageSection variant="light">
      <FormPanel title={t("general")} className="kc-sso-session-template">
        <FormAccess isHorizontal role="manage-realm" onSubmit={form.handleSubmit(save)}>
          <FormGroup
            label={t("defaultSigAlg")}
            fieldId="kc-default-signature-algorithm"
            labelIcon={
              <HelpItem helpText={t("defaultSigAlgHelp")} fieldLabelId="algorithm" />
            }
          >
            <Controller
      ...
      <FormPanel title={t("refreshTokens")} className="kc-client-session-template">
        <FormAccess
          isHorizontal
          role="manage-realm"
      ...
      <FormPanel title={t("accessTokens")} className="kc-offline-session-template">
        <FormAccess
          isHorizontal
          role="manage-realm"
          className="pf-v5-u-mt-lg"
          ...
          >
            <Controller
              ...
              render={({ field }) => (
                <TimeSelector
                  validated={
                    field.value! > ssoSessionIdleTimeout! ? "warning" : "default"
                  }
      ...
      <FormPanel className="kc-login-settings-template" title={t("actionTokens")}>
        <FormAccess
          isHorizontal
          role="manage-realm"
          className="pf-v5-u-mt-lg"
