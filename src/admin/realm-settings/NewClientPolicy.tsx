...
export default function NewClientPolicy() {
  ...
  useFetch(
    ...
    ({ policies, profiles }) => {
      ...
      if (currentPolicy === undefined) {
        currentPolicy = policies.globalPolicies?.find(item => item.name === policyName);
  ...
  const save = async () => {
    ...
    try {
      ...
      addAlert(
        policyName ? t("updateClientPolicySuccess") : t("createClientPolicySuccess"),
              ...
              badges={[
                {
                  ...
                  text: isGlobalPolicy ? <Label color="blue">{t("global")}</Label> : ""
                }
              ]}
              divider
              dropdownItems={
          ...
          <FormProvider {...form}>
            ...
            {(showAddConditionsAndProfilesForm || form.formState.isSubmitted) && (
              <>
                ...
                {policyConditions.length > 0 ? (
                  ...
                  <>
                    <Divider />
                    <Text className="kc-emptyConditions" component={TextVariants.h2}>
                      {t("emptyConditions")}
                    </Text>
                  </>
                )}
            ...
            {(showAddConditionsAndProfilesForm || form.formState.isSubmitted) && (
              <>
                <Flex>
                  <FlexItem>
                    <Text className="kc-client-profiles" component={TextVariants.h1}>
                      {t("clientProfiles")}
                      <HelpItem
                ...
                {policyProfiles.length > 0 ? (
                  ...
                  <>
                    <Divider />
                    <Text className="kc-emptyClientProfiles" component={TextVariants.h2}>
                      {t("emptyProfiles")}
                    </Text>
                  </>
                )}
