    ...
    <UserProfileProvider>
      ...
      <Form onSubmit={form.handleSubmit(save)}>
        <FixedButtonsGroup name="attribute-settings">
          <Button variant="primary" type="submit" data-testid="attribute-create">
      ...
      await Promise.all(
        combinedLocales.map(async selectedLocale => {
          try {
            ...
            const formattedKey =
              formData.displayName?.substring(2, formData.displayName.length - 1) || "";

            const filteredTranslations: TranslationForm[] = Object.entries(translations)
