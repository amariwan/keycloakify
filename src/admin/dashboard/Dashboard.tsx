...
const FeatureItem = ({ feature }: FeatureItemProps) => {
  ...
  return (
    <ListItem className="pf-v5-u-mb-sm">
      ...
      {feature.type === FeatureType.Preview && <Label color="blue">{t("preview")}</Label>}
                ...
                <GridItem lg={2} sm={12}>
                  <Card className="keycloak__dashboard_card">
                    ...
                    <CardBody>
                      <DescriptionList>
                        <DescriptionListGroup>
                          <DescriptionListTerm>{t("totalMemory")}</DescriptionListTerm>
                          <DescriptionListDescription>
                            {serverInfo.memoryInfo?.totalFormated}
                          </DescriptionListDescription>
                          <DescriptionListTerm>{t("freeMemory")}</DescriptionListTerm>
                          <DescriptionListDescription>
                            {serverInfo.memoryInfo?.freeFormated}
                          </DescriptionListDescription>
                          <DescriptionListTerm>{t("usedMemory")}</DescriptionListTerm>
                          <DescriptionListDescription>
