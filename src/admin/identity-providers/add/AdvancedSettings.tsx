...
export const AdvancedSettings = ({ isOIDC, isSAML }: AdvancedSettingsProps) => {
  ...
  return (
    <>
      {!isOIDC && !isSAML && <TextField field="config.defaultScope" label="scopes" />}
      ...
      {isOIDC && <SwitchField field="config.isAccessTokenJWT" label="isAccessTokenJWT" />}
      <SwitchField field="trustEmail" label="trustEmail" fieldType="boolean" />
      <SwitchField field="linkOnly" label="accountLinkingOnly" fieldType="boolean" />
      <SwitchField field="hideOnLogin" label="hideOnLoginPage" fieldType="boolean" />
      ...
      {(!isSAML || isOIDC) && claimFilterRequired && (
        <>
          ...
          >
            ...
            />
            {errors.config?.claimFilterName && <FormErrorText message={t("required")} />}
          </FormGroup>
          <FormGroup
          ...
          >
            ...
            />
            {errors.config?.claimFilterValue && <FormErrorText message={t("required")} />}
          </FormGroup>
        </>
      )}
      <LoginFlow
