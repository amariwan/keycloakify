    ...
    <>
      <FormGroup
        ...
        labelIcon={
          <HelpItem
            helpText={t(
              id === "oidc" ? "useDiscoveryEndpointHelp" : "useEntityDescriptorHelp"
            )}
      ...
      >
        <Switch
          ...
          aria-label={t(id === "oidc" ? "useDiscoveryEndpoint" : "useEntityDescriptor")}
        />
      </FormGroup>
      {discovery && (
        <TextControl
          ...
          labelIcon={t(
            id === "oidc" ? "discoveryEndpointHelp" : "samlEntityDescriptorHelp"
          )}
          type="url"
          placeholder={
            id === "oidc"
