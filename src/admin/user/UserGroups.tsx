...
export const UserGroups = ({ user }: UserGroupsProps) => {
  ...
  const [directMembershipList, setDirectMembershipList] = useState<GroupRepresentation[]>(
    []
  );
      ...
      <KeycloakDataTable
        ...
        onSelect={groups =>
          isDirectMembership
            ...
            : setSelectedGroups(intersectionBy(groups, directMembershipList, "id"))
        }
        isRowDisabled={group =>
          !isDirectMembership && directMembershipList.every(item => item.id !== group.id)
        }
        toolbarItem={
          <>
            <Button
        ...
        columns={[
          ...
          },
          {
            name: "path",
            displayKey: "path",
            cellRenderer: (group: GroupRepresentation) => <GroupPath group={group} />,
