      ...
      <FormProvider {...form}>
        ...
        {user?.id && (
          <>
            <FormGroup label={t("id")} fieldId="kc-id" isRequired>
              <TextInput id={user.id} aria-label={t("userID")} value={user.id} readOnly />
            </FormGroup>
        ...
        {userProfileMetadata ? (
          <>
            ...
            <UserProfileFields
              ...
              t={((key: unknown, params) => t(key as string, params as any)) as TFunction}
            />
          </>
        ) : (
          <>
        ...
        {!user?.id && (
          <FormGroup
            label={t("groups")}
            fieldId="kc-groups"
            labelIcon={<HelpItem helpText={t("groupsHelp")} fieldLabelId="groups" />}
          >
            <Controller
              name="groups"
              defaultValue={[]}
            ...
            />
            {errors.requiredActions && <FormErrorText message={t("required")} />}
          </FormGroup>
        )}
      </FormProvider>
      <FixedButtonsGroup
