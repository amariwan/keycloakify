  ...
  return (
    <>
      ...
      >
        ...
        >
          <FormGroup name="password" label={t("password")} fieldId="password" isRequired>
            <PasswordInput
          ...
          <FormGroup
            ...
            label={
              isResetPassword ? t("resetPasswordConfirmation") : t("passwordConfirmation")
            }
          ...
          >
            ...
            {errors.passwordConfirmation && (
              <FormErrorText message={errors.passwordConfirmation.message as string} />
            )}
          </FormGroup>
          <FormProvider {...form}>
