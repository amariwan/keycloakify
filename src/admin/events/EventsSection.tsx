            ...
            >
              ...
              >
                            ...
                            {field.value.map(chip => (
                              <Chip
                                ...
                                onClick={event => {
                                  ...
                                  field.onChange(field.value.filter(val => val !== chip));
                                }}
                              >
                ...
                <ActionGroup>
                  ...
                  <Button variant="secondary" onClick={resetSearch} isDisabled={!isDirty}>
                    {t("resetBtn")}
                  </Button>
                </ActionGroup>
              </Form>
                  ...
                  return (
                    ...
                    >
                      {typeof value === "string" ? (
                        ...
                        value.map(entry => (
                          <Chip key={entry} onClick={() => removeFilterValue(key, entry)}>
  ...
  return (
    <>
      <ViewHeader
        ...
        subKey={
          <Trans i18nKey="eventExplain">
            If you want to configure user events, Admin events or Event listeners, please
            enter
            <Link to={toRealmSettings({ realm, tab: "events" })}>{t("eventConfig")}</Link>
      ...
      <PageSection variant="light" className="pf-v5-u-p-0">
        <RoutableTabs isBox defaultLocation={toEvents({ realm, tab: "user-events" })}>
          <Tab title={<TabTitleText>{t("userEvents")}</TabTitleText>} {...userEventsTab}>
