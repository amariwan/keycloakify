...
export const PersonalInfo = () => {
  ...
  const allFieldsReadOnly = () =>
    userProfileMetadata?.attributes?.map(a => a.readOnly).reduce((p, c) => p && c, true);
    ...
    <Page title={t("personalInfo")} description={t("personalInfoDescription")}>
      <Form isHorizontal onSubmit={handleSubmit(onSubmit)}>
        <UserProfileFields
          ...
          t={((key: unknown, params) => t(key as TFuncKey, params as any)) as TFunction}
          renderer={attribute =>
        ...
        {!allFieldsReadOnly() && (
          <ActionGroup>
            <Button data-testid="save" type="submit" id="save-btn" variant="primary">
              {t("save")}
            </Button>
            <Button
              data-testid="cancel"
        ...
        {context.environment.features.deleteAccountAllowed && (
          <ExpandableSection data-testid="delete-account" toggleText={t("deleteAccount")}>
            <Alert
              isInline
