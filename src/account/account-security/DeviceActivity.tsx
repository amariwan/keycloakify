 ...
 *
 * $ npx keycloakify own --path 'account/account-security/DeviceActivity.tsx'
 *
...
export const DeviceActivity = () => {
  ...
  return (
    <Page title={t("deviceActivity")} description={t("signedInDevicesExplanation")}>
      ...
      <DataList className="signed-in-device-list" aria-label={t("signedInDevices")}>
              ...
              <DataListItemRow key={device.id} data-testid={`row-${index}`}>
                ...
                >
                  <Grid hasGutter>
                    ...
                    <GridItem className="pf-v5-u-text-align-right" sm={3} md={2} span={1}>
                      {!session.current && (
                        <ContinueCancelModal
                    ...
                    <GridItem span={11}>
                      ...
                      >
                        ...
                        <DescriptionListGroup>
                          <DescriptionListTerm>{t("lastAccessedOn")}</DescriptionListTerm>
                          <DescriptionListDescription>
                            {formatDate(new Date(session.lastAccess * 1000))}
                          </DescriptionListDescription>
                        </DescriptionListGroup>
                        <DescriptionListGroup>
                          <DescriptionListTerm>{t("clients")}</DescriptionListTerm>
                          <DescriptionListDescription>
