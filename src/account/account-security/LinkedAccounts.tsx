...
export const LinkedAccounts = () => {
  ...
  const [unlinkedAccounts, setUninkedAccounts] = useState<LinkedAccountRepresentation[]>(
    []
  );
      ...
      <Stack hasGutter>
        <StackItem>
          ...
          <LinkedAccountsToolbar
            onFilter={search => setParamsLinked({ ...paramsLinked, first: 0, search })}
        ...
        <StackItem>
          <Title headingLevel="h2" className="pf-v5-u-mt-xl pf-v5-u-mb-lg" size="xl">
