  ...
  return (
    ...
    >
      <Form id="share-form" onSubmit={handleSubmit(addShare)}>
        <FormGroup label={t("shareUser")} type="string" fieldId="users" isRequired>
          <InputGroup>
            <InputGroupItem>
              <TextInput
                id="users"
          ...
          {errors.usernames && <FormErrorText message={errors.usernames.message!} />}
        </FormGroup>
        <FormProvider {...form}>
          <FormGroup label="" fieldId="permissions-selected" data-testid="permissions">
            <SelectControl
              name="permissions"
